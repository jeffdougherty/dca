...
Also requires a MySQLite database with the required Command at Sea reference data, which is proprietary.  It will be supplied to approved project contributors on request.
